...
fig.add_trace(go.Scatter(visible=False, name="Step 1", line=dict(color='red'), x=[1,2], y=[1, 3]))
fig.add_trace(go.Scatter(visible=False, name="Step 2", line=dict(color='purple'), x=[2,3], y=[3, 6]))
fig.add_trace(go.Scatter(visible=False, name="Step 3", line=dict(color='green'), x=[3,4], y=[6, 10]))
